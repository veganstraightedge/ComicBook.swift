...
- PDF (PDFKit), CB7 (SWCompression read + `7zz` write), and CBR (`lsar`/`unar`, read-only) adapters
  are stubbed and throw "not yet ported". CBA (ACE) is unsupported, matching the gem.
